...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0/css/all.min.css"/>
    <!-- Bootstrap -->
    <link href="{{asset('backend/log/css/bootstrap.min.css')}}" rel="stylesheet">
    <!-- Font Awesome -->
    <link href="{{asset('backend/log/css/font-awesome.min.css')}}" rel="stylesheet">
    <!-- Animate.css -->
    <link href="{{asset('backend/log/css/animate.min.css')}}" rel="stylesheet">

    <!-- Custom Theme Style -->
    <link href="{{asset('backend/log/css/custom.min.css')}}" rel="stylesheet">
  </head>
  ...
  <body class="login">
    ...
    <script src="{{asset('backend/log/js/bootstrap.min.js')}}"></script>
  </body>
</html>
